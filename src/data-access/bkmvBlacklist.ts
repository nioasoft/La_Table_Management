/**
 * BKMV Blacklist - רשימה שחורה להתאמות ספקים
 *
 * חשוב: הרשימה משפיעה רק על הקשר התאמות ספקים!
 * - שמות ברשימה לא יופיעו בתוצאות ההתאמה
 * - הנתונים המקוריים נשמרים בקבצי BKMVDATA
 * - דוחות עתידיים עדיין יכולים לגשת לנתונים המקוריים
 *
 * שימושים: חשבונות פנימיים, ישויות שאינן ספקים
 */
