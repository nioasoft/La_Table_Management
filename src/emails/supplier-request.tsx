...
export function SupplierRequestEmail({
  ...
  const t = emailTranslations.supplierRequest;
  const common = emailTranslations.common;

  // Build subject line using Hebrew translations
  const subject = emailSubjects.supplierRequest(period);
  ...
  const submitByMessage = interpolateEmail(t.submitBy, {
    deadline: deadline,
  });
  ...
  return (
    <EmailLayout preview={subject}>
      <Section style={section}>
        ...
        <Text style={text}>{submitByMessage}</Text>
