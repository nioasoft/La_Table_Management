...
export const he = {
  ...
  upload: {
    ...
    errors: {
      invalidFileType: "סוג הקובץ אינו נתמך. יש להעלות קובץ Excel (‎.xlsx או ‎.xls) או CSV.",
      fileTooLarge: "הקובץ גדול מדי (מקסימום {maxSize}). נסי לשמור אותו מחדש או לפצל אותו.",
      uploadFailed: "ההעלאה נכשלה. נסי שוב, ואם הבעיה חוזרת — צרי איתנו קשר.",
    },

    duplicate: {
      title: "כבר קיים דוח לתקופה זו",
      message: "כבר קיים במערכת הדוח \"{fileName}\" לאותו זכיין ותקופה. אם זה דוח מעודכן — לחצי 'החלף קובץ קיים'. אחרת — בטלי.",
      replace: "החלף קובץ קיים",
      cancel: "ביטול",
    },
